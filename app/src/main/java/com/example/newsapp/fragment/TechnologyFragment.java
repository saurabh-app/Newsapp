...
public class TechnologyFragment extends Fragment {
    private RecyclerView technologyrecycleview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        technologyrecycleview = view.findViewById(R.id.technologyrecycleview);
        technologyrecycleview.setLayoutManager(new LinearLayoutManager(getContext()));
            ...
            call.enqueue(new Callback<MasterResponceModel>() {
                ...
                public void onResponse(Call<MasterResponceModel> call, Response<MasterResponceModel> response) {
                    ...
                    if (status.equals("ok")) {
                        ...
                        newsListAdapter = new NewsListAdapter(getContext(), sourcesmodel);
                        technologyrecycleview.setAdapter(newsListAdapter);
